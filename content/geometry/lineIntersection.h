...
\begin{minipage}{75mm}
 ...
 The wrong position will be returned if P is complex<ll> and the intersection point 
 does not have integer coordinates. Products of three coordinates are used in intermediate 
